	    		...
	    		<table class="form-table">
		    		<tr>
		    			...
		    			<td><input class="easyui-textbox form-input" name="loginname" 
		    				data-options="" maxlength="255" missingMessage="请填写登录名" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 角色名:</td>
		    			<td><input class="easyui-textbox form-input" name="rolename" 
		    				data-options="" maxlength="255" missingMessage="请填写角色名" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 内容:</td>
		    			<td><input class="easyui-textbox form-input" name="content" 
		    				data-options="" maxlength="1024" missingMessage="请填写内容" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 客户端ip:</td>
		    			<td><input class="easyui-textbox form-input" name="clientip" 
		    				data-options="" maxlength="255" missingMessage="请填写客户端ip" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 创建时间:</td>
		    			<td><input class="easyui-datetimebox form-input" name="createtime" 
