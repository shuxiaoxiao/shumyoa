		...
		<div id="dlg" class="easyui-dialog" style="width:450px;height:360px;" 
	    	...
	    	<form id="fm" method="post" novalidate>
	    		...
	    		<table class="form-table">
		    		...
		    		<tr>
		    			<td class="form-td-left"> 文字描述:</td>
		    			<td><input class="easyui-textbox form-input" name="name" 
		    				data-options="" maxlength="255" missingMessage="请填写文字描述" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 具体值:</td>
	...
	$(function(){
		...
		$grid.datagrid({
		    ...
		    columns:[[
				...
				{field:'pid',title:'父id'},    
				{field:'name',title:'文字描述'},    
				{field:'value',title:'具体值'},    
		    ]] ,
		    toolbar:[{
	    		text:'新 增' ,
				iconCls:'icon-add' , 
		...
		if(row.length <=0){
	        ...
	        $.messager.confirm('提示','确定要删除此信息?',function(r){
	        	if(r){
		            ...
		            $.ajax({
		            	url:'${path}/sysDictionary/delete/'+ids,
		            	dataType:"text",
