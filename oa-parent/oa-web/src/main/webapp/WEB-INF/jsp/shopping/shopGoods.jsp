  ...
  <body>
    <div class="easyui-layout" style="width:100%;height:100%;">
		<div data-options="region:'north',split:true " style="height:40px;padding: 3px;">
			...
			-->
			商品名称：<input type="text" id="query_name" />&nbsp;
		...
		<div id="dlg" class="easyui-dialog" style="width:450px;height:360px;" 
	    	...
	    	<form id="fm" method="post" novalidate>
	    		...
	    		<table class="form-table">
		    		<tr>
		    			<td class="form-td-left"> 商品名称:</td>
		    			<td><input class="easyui-textbox form-input" name="name" 
		    				data-options="required:true" maxlength="255" missingMessage="请填写商品名称" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 数量:</td>
		    			<td><input class="easyui-numberbox form-input" name="quantity" 
		    				data-options="" maxlength="" missingMessage="请填写数量" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 原价:</td>
		    			<td><input class="easyui-numberbox form-input" name="origprice" 
		    				data-options="" maxlength="" missingMessage="请填写原价" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 折扣:</td>
		    			<td><input class="easyui-textbox form-input" name="discount" 
		    				data-options="" maxlength="1" missingMessage="请填写折扣" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 售价:</td>
		    			<td><input class="easyui-numberbox form-input" name="price" 
		    				data-options="" maxlength="" missingMessage="请填写售价" />
		    			</td>
		    		</tr>
		    	</table>
	        </form>
